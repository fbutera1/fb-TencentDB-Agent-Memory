...
**输出语言**：所有自由文本字段（\`scene_name\`、memory \`content\`）English. All scene_name and memory content MUST be written in English, regardless of the language used in user messages. JSON field names, enum values, and ISO timestamps remain in English。
